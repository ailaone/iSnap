...
class AnnotationWindowController: NSWindowController {
    ...
    convenience init(image: CGImage) {
        ...
        let minimumToolbarWidth: CGFloat = 620
        let windowWidthPoints = max(imageWidthPoints + 24, minimumToolbarWidth)
        let windowHeightPoints = imageHeightPoints + 104
        ...
        window.minSize = NSSize(width: minimumToolbarWidth, height: 320)
